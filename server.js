...
app.get('/volunteer/api', function(req, res) {
  db.collection('users').find().toArray((err, result) => {
	  res.render('volunteer.ejs', {users: result});
  })
});
...
app.post('/feed', function (req, res) {
  ...
  db.collection('contacts').update({name:Name},{$push: {comments: {post:profile+': '+ req.body.comment}}})
